...
import  { columns as columnsCoordinator} from "./coordinator/coordinator-table-column";
  ...
  return (
    <div className="p-4">
      ...
      <Card className="my-5">
        ...
        <CardContent>
          <CoordinatorTable columns={columnsCoordinator} data={coordinatorDummy} />
        </CardContent>
      </Card>
      <Card className="my-5">
        <CardHeader>
        ...
        <CardContent>
          <StockOpnameTable columns={columnsStockOpname} data={stockOpnameDummy} />
        </CardContent>
      </Card>
    </div>
  );
